 ...
 */
  ...
  #define THERMAL_PROTECTION_PERIOD 60        // (seconds)  // 40
  #define THERMAL_PROTECTION_HYSTERESIS 8     // (°C)       // 4
   ...
   * below 2.
   */
  #define WATCH_TEMP_PERIOD  60               // (seconds) // 40
  #define WATCH_TEMP_INCREASE 5               // (°C)      // 2
#endif
